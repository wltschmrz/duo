...
CUDA_VISIBLE_DEVICES=2,3 RESUME_CKPT_PATH="/mnt/data1/geonyounglee/workspace/ddlms/outputs/lm1b/2026.04.08/211301/checkpoints/best.ckpt" \
WANDB_NAME="sfldd-lm1b-wrap-small-100k-H200x4" SEED=1 \
PER_GPU_BATCH=32 \
nohup bash "myscripts/train_lm1b_sfldd_sentencepacking.sh" \
  > watch_folder/sfldd_lm1b_wrap_h200x4-2.log 2>&1 &
